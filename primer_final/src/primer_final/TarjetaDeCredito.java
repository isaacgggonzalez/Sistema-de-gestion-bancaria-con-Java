...
public class TarjetaDeCredito {
    ...
    private int cliente_asociado;  

    // Constructor
    public TarjetaDeCredito(double deuda_tarjeta, double limite_tarjeta, String vencimiento_tarjeta, String nro_tarjeta, int cliente_asociado) {
    ...
    public int getCliente_asociado() {
        return cliente_asociado;
    }

    public void setCliente_asociado(int cliente_asociado) {
        this.cliente_asociado = cliente_asociado;
    }
